...
class TLToAXI4(val combinational: Boolean = true, val adapterName: Option[String] = None, val stripBits: Int = 0, val wcorrupt: Boolean = true) extends Module
{
...
object TLToAXI4
{
  def apply(combinational: Boolean = true, adapterName: Option[String] = None, stripBits: Int = 0, wcorrupt: Boolean = true) =
  {
    val tl2axi4 = Module(new TLToAXI4(combinational, adapterName, stripBits, wcorrupt))
    tl2axi4.node
  }
